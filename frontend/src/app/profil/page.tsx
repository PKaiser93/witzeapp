        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-gray-900/80 backdrop-blur-xl border border-gray-800/50 rounded-2xl p-6 text-center">
              ...
              <p className="text-3xl font-black text-white">{profile?.witze.length ?? 0}</p>
              <p className="text-gray-400 text-sm mt-1 uppercase tracking-wider font-medium">Witze gepostet</p>
            </div>
            ...
            <div className="bg-gray-900/80 backdrop-blur-xl border border-gray-800/50 rounded-2xl p-6 text-center">
              ...
              <p className="text-3xl font-black text-white">{profile?.likesReceived ?? 0}</p>
              <p className="text-gray-400 text-sm mt-1 uppercase tracking-wider font-medium">Likes erhalten</p>
            </div>
          ...
          <div className="bg-gray-900/80 backdrop-blur-xl border border-gray-800/50 rounded-3xl p-8">
            ...
            {!loading && (profile?.witze.length ?? 0) === 0 && (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500 text-sm mb-6">Deine Witze erscheinen hier.</p>
                  <button
                      onClick={() => router.push('/post')}
