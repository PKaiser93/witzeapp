              ...
              >
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    ...
                    {/* Witz */}
                    <div
                      className="p-3 bg-gray-900/50 rounded-xl border border-gray-700/50 cursor-pointer hover:border-gray-600/50 transition-all"
                      onClick={() => router.push(`/witze/${r.witz.id}`)}
                    >
                  ...
                  <div className="flex flex-col gap-2 flex-shrink-0">
                    ...
                    <button
                      ...
                      className="px-4 py-2 bg-red-500/20 hover:bg-red-500/30 border border-red-500/30 text-red-300 text-xs font-medium rounded-xl transition-all"
                    >
                      🗑️ Witz löschen
                    </button>
                  </div>
