...
export default function PostPage() {
  ...
  const loadKategorien = useCallback(async () => {
    try {
      ...
      // Kategorien sind optional, Fehler hier ist nicht kritisch
    }
  }, []);
  ...
  const posten = async () => {
    if (!text.trim() || loading || !isLoggedIn || !accessToken) return;
    setLoading(true);
    setError(null);
    try {
    ...
    <AppLayout>
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-black text-white mb-1">Neuer Witz 🚀</h1>
